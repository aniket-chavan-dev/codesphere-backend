  ...
  return (
    <div className="w-full h-full p-4 flex flex-col overflow-auto">
      <div className="flex justify-between items-center">
        <h3 className="text-red-500 text-xl">Runtime Error</h3>
      ...
      <div className=" pt-4">
        <div className="w-full  bg-errorbackground rounded-xl relative  group">
          <p className="p-3 whitespace-pre-line text-red-600 text-sm ">
            {result.sub_data.error_message}
          </p>
          <div>
            <CopyCom text={result.sub_data.error_message} />
          </div>
        </div>
      </div>
      ...
      <div className="text-sm text-textdarkish flex justify-between items-center pt-3">
        ...
        <div className="flex gap-1 items-center hover:bg-bordergrey p-1 cursor-pointer rounded-lg">
          <div>
            <NotepadText size={18} />
          </div>
